      ...
      <div className="container mx-auto py-10 px-6 md:px-12 lg:px-24">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mb-6 md:mb-0 flex flex-wrap justify-center gap-6">
            <Link to="/" className="text-gray-400 hover:text-gold transition-colors text-sm">Home</Link>
            <Link to="/about" className="text-gray-400 hover:text-gold transition-colors text-sm">About</Link>
            <Link to="/services" className="text-gray-400 hover:text-gold transition-colors text-sm">Services</Link>
            <Link to="/portfolio" className="text-gray-400 hover:text-gold transition-colors text-sm">Portfolio</Link>
            <Link to="/contact" className="text-gray-400 hover:text-gold transition-colors text-sm">Contact</Link>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-800 text-center text-gray-500 text-xs">
          <p>&copy; {new Date().getFullYear()} Vynora Wedding Company. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
